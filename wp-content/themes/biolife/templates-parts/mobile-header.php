 ...
 * @var $menu_locations
 */
$mobile_banner = biolife_get_option('mobile_banner');
...
$author_name  = esc_html__('Guest', 'biolife');
$login_text   = esc_html__('Login', 'biolife');
$author_email = esc_html__('Example@email.com', 'biolife');
...
if (is_user_logged_in()) {
    ...
    $login_text   = esc_html__('Logout', 'biolife');
    ...
    <a href="<?php echo esc_url($login) ?>" class="avatar">
        <figure>
            <img src="<?php echo esc_url($avatar) ?>"
                 alt="<?php echo esc_attr__('Avatar Mobile', 'biolife') ?>">
        </figure>
    </a>
    <div class="author">
