...
if (!class_exists('Ovic_Import_Database_Content')) {
    class Ovic_Import_Database_Content
    {
        ...
        {
            return 'https?(%3A|:)[%2F\\/]+(rc|demo|new-biolife)\.kutethemes\.net';
        }
        ...
        public function required_plugins($plugins)
        {
            return array(
                ...
                array(
                    ...
                    'source'      => 'https://plugins.kutethemes.net/ovic-addon-toolkit.zip',
                    'source_type' => 'external',
                ...
                array(
                    ...
                    'source'      => 'https://plugins.kutethemes.net/ovic-product-bundle.zip',
                    'source_type' => 'external',
                ...
                array(
                    ...
                    'source'      => 'repo',
                    'source_type' => 'repo',
                    'file_path'   => 'classic-widgets/classic-widgets.php',
                ),
                array(
        ...
        public function sample_data_packages($packages)
        {
            return array(
                'main' => array(
                    ...
                    'demo'      => 'https://new-biolife.kutethemes.net',
                    ...
                    if (!empty($items)) {
                        foreach ($items as $item) {
                            ...
                            if (!empty($_menu_item_url)) {
                                $_menu_item_url = str_replace('https://new-biolife.kutethemes.net', $home_url, $_menu_item_url);
                                $_menu_item_url = str_replace('http://new-biolife.kutethemes.net', $home_url, $_menu_item_url);
