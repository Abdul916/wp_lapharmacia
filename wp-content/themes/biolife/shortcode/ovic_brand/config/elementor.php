...
class Elementor_Ovic_Brand extends Ovic_Widget_Elementor
{
    ...
    {
        return esc_html__( 'Brand', 'biolife' );
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'category',
            [
                'label'       => esc_html__( 'Products Brand', 'biolife' ),
        ...
        $this->add_responsive_control(
            'space',
            [
                'label'      => esc_html__( 'Padding', 'biolife' ),
        ...
        $this->add_group_control(
            ...
            [
                'name'     => 'border',
                'label'    => esc_html__( 'Border', 'biolife' ),
        ...
        $this->add_control(
            'full_width',
            [
                'label'     => esc_html__( 'Item Full Width', 'biolife' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label'   => esc_html__( 'Ovic Hover Animation', 'biolife' ),
