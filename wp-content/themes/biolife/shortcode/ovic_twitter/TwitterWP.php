...
if ( !class_exists( 'TwitterWP' ) ) :
    ...
    class TwitterWP
    {
        ...
        public function get_user( $user = '' )
        {
            ...
            if ( !self::$user ) {
                return new WP_Error( 'twitterwp_error', esc_html__( 'ERROR: You need to provide a user.', 'biolife' ) );
            }
        ...
        public function api_bearer_token()
        {
            ...
            if ( !isset( $body->access_token ) ) {
                return new WP_Error( 'twitterwp_error', esc_html__( 'ERROR: Could not retrieve bearer token.', 'biolife' ) );
            }
        ...
        public static function app_setup_error( $app = array(), $return = false )
        {
            ...
            return new WP_Error( 'twitterwp_error', esc_html__( 'ERROR: Missing Twitter App credentials.', 'biolife' ) );
        }
        ...
        public static function show_wp_error( $error, $echo = true )
        {
            ...
            if ( $echo ) {
                echo wp_specialchars_decode( $errors );
            }
