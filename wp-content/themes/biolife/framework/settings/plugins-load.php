...
if ( !function_exists( 'biolife_plugin_load' ) ) {
    function biolife_plugin_load()
    {
        /*
        ...
        $plugins = array(
            ...
            array(
                ...
                'source'   => esc_url( 'https://plugins.kutethemes.net/ovic-addon-toolkit.zip' ),
                'version'  => '2.6.2',
                'required' => true,
            ),
            array(
            ...
            array(
                ...
                'source'   => esc_url( 'https://plugins.kutethemes.net/ovic-product-bundle.zip' ),
                'version'  => '1.1.3',
                'required' => true,
            ),
            array(
                ...
                'source'   => esc_url( 'https://plugins.kutethemes.net/ovic-import-demo.zip' ),
                'version'  => '1.6.4',
                'required' => true,
            ),
            array(
...
add_action( 'tgmpa_register', 'biolife_plugin_load' );
